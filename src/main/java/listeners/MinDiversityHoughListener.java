...
public class MinDiversityHoughListener implements AdjustmentListener {
	final Label label;
	final float min, max;
	...
	public MinDiversityHoughListener(final Interactive_MTDoubleChannel parent, final Label label, final float min, final float max, final int scrollbarSize,
			final Scrollbar minDiversityScrollbar) {
		this.label = label;
		this.min = min;
		this.max = max;
