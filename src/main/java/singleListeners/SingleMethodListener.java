...
public class SingleMethodListener implements ActionListener {
	...
	public SingleMethodListener(final Interactive_MTSingleChannel parent, final JComboBox<String> choice){
