...
public class SegmentbyWatershed <T extends NativeType<T>> extends BenchmarkAlgorithm
implements OutputAlgorithm <RandomAccessibleInterval<IntType>> {
	 ...
	 */
	public SegmentbyWatershed(final RandomAccessibleInterval<T> source, final RandomAccessibleInterval<BitType> bitimg){
