...
public class SingleBatchMode implements PlugIn, Runnable {

	public final Interactive_MTSingleChannel parent;
	...
	public boolean AdvancedChoiceSeeds = false;
	   public double maxdist = LocalPrefs.getDouble(".Maxdist.double", Math.PI / 4);
	...
	public SingleBatchMode() {
		this.parent = null;
		this.AllImages = null;
	};

	public SingleBatchMode(final File[] AllImages, final Interactive_MTSingleChannel parent, final File batchdirectory) {
