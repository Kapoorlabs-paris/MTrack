...
public class DisplaysubGraphendKalman {
	...
	public DisplaysubGraphendKalman(final ImagePlus imp, final ArrayList<SubgraphsKalman> subgraph, ArrayList<Pair<Integer, double[]>> ID ){
	...
	public DisplaysubGraphendKalman(final ImagePlus imp, final ArrayList<SubgraphsKalman> subgraph, int frame){
...
public DisplaysubGraphendKalman(final ImagePlus imp, final ArrayList<SubgraphsKalman> subgraph, int frame, ArrayList<float[]> Kymo){
